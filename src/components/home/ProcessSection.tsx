  ...
  return (
    <section className="border-t border-border py-20 sm:py-32">
      <Container>
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 sm:mt-20 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 lg:gap-0">
          {processSteps.map((step) => (
            <div
              key={step.number}
              className="flex flex-col gap-3 border-t border-accent/70 pt-5 sm:gap-4 sm:pt-6 lg:border-r lg:border-t-0 lg:pl-10 lg:pr-8 lg:pt-0 lg:first:pl-0 lg:last:border-r-0 lg:last:pr-0"
            >
